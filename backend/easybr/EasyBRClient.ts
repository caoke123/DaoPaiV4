// ────────────────────────────────────────────────────────────
// ⚠️ LEGACY ONLY — V1/V2 EasyBR HTTP client. DO NOT USE for V4.
// ────────────────────────────────────────────────────────────
// M5-2A confirmed: EasyBRClient is NEVER called in V4 production.
// The only importer is BrowserPool.ts, whose init() fails silently
// (EasyBR API at localhost:3001 is not running).
//
// All V4 window management now routes through:
//   - Agent WS commands → Portable Chrome (startup/close)
//   - SSE + playwright-windows endpoint (status)
//   - PlaywrightWindowAdapter (task execution)
//
// This file is frozen for backwards-compat reference.
// Do not add new callers. Do not restore EasyBR as V4 launch path.
// ────────────────────────────────────────────────────────────
